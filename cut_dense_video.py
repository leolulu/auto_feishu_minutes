...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--max_delta_second', help='如果指定，则字幕中如存在特定字符，将限制单句时长为此秒', type=float)
    parser.add_argument('-a', '--max_all_second', help='如果指定，将限制字幕所有单句时长为此秒，此选项优先级大于max_delta_second', type=float)
